        ...
        // 0x1121 should be single axis and 0x1521 should be tri-axis
            ...
            switch (decode.vibration_information.frame_format) {
                ...
                case 2:
                    ...
                    // Ce nombre contient tous les peaks
                    let peaks = arrayConverter(bytes, offsetStartPeaks, peak_size * decode.vibration_data.peak_cnt, false)
                    ...
                    for (let peakIndex = 0; peakIndex < decode.vibration_data.peak_cnt; peakIndex++) {
                        ...
                        peak_data.magnitude = getBits(peaks, peakIndex * peak_size + 11, 8)
...
/** Prends un octet, size et index et retourne les bits correspondant
 * 
...
function getBits(number, index, size) {
    ...
    if (typeof index !== 'number' || index < 0) {
        return "Invalid index input. Please provide a non-negative number.";
    }

    if (typeof size !== 'number' || size < 1) {
        return "Invalid size input. Please provide a positive number.";
    }
