...
export default function App() {
  ...
  const triggerMeasurement = async () => {
    ...
    if (service)
      await writeCharacteristic(service, CHARACTERISTICS.measurementTrigger, Uint8Array.of(0x01));
  };
  ...
  async function switchDFU() {
    ...
    if (service) {
      ...
      await writeCharacteristic(service, CHARACTERISTICS.DFUButtonlessWithoutBonds, Uint8Array.of(0x01));
